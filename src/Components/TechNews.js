...
export default function TechNews() {
  ...
  useEffect(() => {
    async function getData() {
      var res = await fetch(
        "https://newsapi.org/v2/everything?q=Tech&apiKey=3834a362799b4358aa40ffd7ca3791b8"
      );
  ...
  return (
    <div>
        ...
        <div class="container py-lg-4 py-md-3">
          <div class="most-recent">
            <div class="title-align mb-4">
              <h3 class="title-left">Tech Industry</h3>
      ...
      <div className="btn-container">
        <Link to="/techNews" className="btn btn-style btn-primary">View All Aricles</Link>
      </div>
    </div>
